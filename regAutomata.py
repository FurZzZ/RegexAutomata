...
class Application:
    ...
    def run(self):
        ...
        for i in numberOfAutomatas:
                ...
                for c in fragmentRegex:
                    if c == "(":
                        ...
                        if isBracketOpen == 0:
                            try:
                                ...
                                if positionOfBracket == -1:
                                    newState = State("S" + str(numberOfTheStateNameNNN - 1), True,
                                                     stateList[numberOfTheStateNameNNN - 1].stateName,
                                                     fragmentRegex[positionInRegex - 1])
                                    stateList.append(newState)
                                else:
                                    if positionInRegex + 1 == len(fragmentRegex):
                                        newState = State(stateList[numberOfTheStateNameNNN - 1].stateName, True,
                                                         "S" + str(numberOfTheStateNameNNN - 1),
                                                         fragmentRegex[positionOfBracketChar + 1])
                                    else:
                                        newState = State(stateList[numberOfTheStateNameNNN - 1].stateName, False,
                                                         "S" + str(numberOfTheStateNameNNN - 1),
                                                         fragmentRegex[positionOfBracketChar + 1])
                                    stateList.append(newState)
                                    numberOfTheStateName += 1
                            ...
                            newState = State("S" + str(numberOfTheStateNameNNN - 1), True,
                                             stateList[numberOfTheStateNameNNN].stateName,
                                             fragmentRegex[positionInRegex - 1])
                            stateList.append(newState)
                    elif c == "*":
                        ...
                        if isBracketOpen == 0:
                            try:
                                ...
                                if positionOfBracket == -1:
                                    ...
                                    if positionInRegex + 1 == len(fragmentRegex):
                                        newState = State(stateList[numberOfTheStateNameNNN - 2].stateName, True,
                                                         "S" + str(numberOfTheStateNameNNN - 1),
                                                         fragmentRegex[positionOfBracketChar + 1])
                                    else:
                                        newState = State(stateList[numberOfTheStateNameNNN - 2].stateName, False,
                                                         "S" + str(numberOfTheStateNameNNN - 1),
                                                         fragmentRegex[positionOfBracketChar + 1])
                                    stateList.append(newState)
                                    numberOfTheStateName += 1
                        ...
                        if (numberOfTheStateName == 1):
                            ...
                            newState = State("S" + str(numberOfTheStateNameNNN), helper,
                                             "S" + str(numberOfTheStateNameNNN - 1), c)
                        stateList.append(newState)
                        numberOfTheStateName += 1
                        numberOfTheStateNameNNN += 1
                    positionInRegex += 1
            for x in stateList:
                print (
                "| from state: " + str(x.fromWhichState) + " to state: " + str(x.stateName) + " influenced by: " + str(
                    x.influencedBy) + " is ending state? : " + str(x.isFinalState) + " |")
        return stateList
